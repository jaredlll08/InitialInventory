...
dependencies {
    ...
    implementation(fg.deobf("com.blamejared.crafttweaker:CraftTweaker-forge-${minecraftVersion}:${crafttweakerVersion}"))
}
...
modrinth {
    ...
    versionName.set("Forge-${minecraftVersion}-$version")
